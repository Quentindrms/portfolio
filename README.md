Generated with [vike.dev/new](https://vike.dev/new) ([version 542](https://www.npmjs.com/package/create-vike/v/0.0.542)) using this command:

```sh
pnpm create vike@latest --solid --tailwindcss
```
